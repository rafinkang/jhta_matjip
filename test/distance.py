...
for j in range(10):
    try: 
        ...
        if browser.find_element_by_css_selector('#panel01 > div > div.sc_box.contact > div.contact_area > div > div > ul:nth-child(2) > li:nth-child(1) > div:nth-child(2) > div > a ') == '종로3가':
