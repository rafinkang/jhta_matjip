...
class Menu(QWidget):
    ...
    def initUI(self, parent):
        ...
        icon_matjip  = QIcon('E:\dev/jhta_matjip/images/restaurant.png')
        self.btn1.setIcon(icon_matjip)
        self.btn1.resize(200, 300)
        self.btn1.setIconSize(QSize(200, 300))
        icon_cafe  = QIcon('E:\dev/jhta_matjip/images\cafe.png')
        self.btn2.setIcon(icon_cafe)
        self.btn2.resize(200, 300)
        self.btn2.setIconSize(QSize(200, 300))
        icon_mart  = QIcon('E:\dev/jhta_matjip/images\mart.png')
        self.btn3.setIcon(icon_mart)
        self.btn3.resize(200, 300)
        self.btn3.setIconSize(QSize(200, 300))
        icon_party  = QIcon('E:\dev/jhta_matjip/images\party.png')
        self.btn4.setIcon(icon_party)
        self.btn4.resize(200, 300)
        self.btn4.setIconSize(QSize(200, 300))
        icon_logout  = QIcon('E:\dev/jhta_matjip/images\logout.png')
